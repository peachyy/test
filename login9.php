			...
			<ul>
				...
				<li class="main_left04">
					<div class="main_left05">
						<ul>
							<li style="display:none"><div>重庆新思维信息技术有限公司</div></li>
		...
		<div class="main_center_main">
 			<div class="main_center_main01">
				...
				<li class="Login">
					...
					<tr>
						<td colspan="2" style="line-height:20px; text-indent:70px;"> <?php echo"$domain";?></td>
					</tr>
					<tr>
						<td colspan="2" style="line-height:20px; text-indent:70px;"> <?php echo"$domain";?></td>
					</tr>
...
<div class="CopyRight">
	 <?php echo $date;?><br />
	CopyRight © <?php echo $domain_purchase['corpname'];?> 2004&nbsp;&nbsp;<a href="http://www.innoway.cn">Power by innoway</a></div>
</div>
</body>
</html>
